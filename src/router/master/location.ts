...
import { fetchStates, checkStates } from "../../controllers/locations/states/fetch-states-all.controller";
...
import { fetchDistricts, checkDistricts } from "../../controllers/locations/districts/get-districts-all.controller";
...
import { fetchBlocks, checkBlocks } from "../../controllers/locations/blocks/fetch-blocks-all.controller";
...
import { fetchVillages, checkVillages } from "../../controllers/locations/villages/get-villages-all.controller";
...
router.post("/check-states", checkStates);
...
router.post("/check-districts", checkDistricts);
...
router.post("/check-villages", checkVillages);
